...
# Reference: sklearn.linear_model.LinearRegression docs
...
class RFClassifier():
    ...
    def randomForestClassifier(self,x_train,x_test, y_train):
        ...
        y_predict_train, y_predict_test = rf_clf.predict(x_train),rf_clf.predict(x_test)
...
# Q3.3.2 Hyper-parameter Tuning
    ...
    def hyperParameterTuning(self,rf_clf,x_train,y_train):
        ...
        gscv_rfc = GridSearchCV(rf_clf, param_grid = params)
